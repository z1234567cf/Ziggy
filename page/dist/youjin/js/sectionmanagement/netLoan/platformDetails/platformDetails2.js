...
function dataClassify(data) {
    ...
    _1=[
        {"hdid":data["hdid"], "zcf_name":"hdid",},
        {"title":data["title"], "zcf_name":"title",},
    ];
    _2=[
        {"href_url":data["href_url"], "zcf_name":"href_url",},
    ];
    var _data=[_1,_2];
    return _data;
}
...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Wd&s=getWdInsideHuodonglist&is_open=0&start="+star+"&limit="+evSize+"&ptid="+relational.ptid;
            break;
        case 1:
            url=relational.url+"?m=Wd&s=getWdInsideHuodonglist&is_open=1&start="+star+"&limit="+evSize+"&ptid="+relational.ptid;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Wd&s=getWdInsideHuodonglist&is_open=0&name="+numeber+"&start="+star+"&limit="+size+"&ptid="+relational.ptid;
            break;
        case 1:
            url=relational.url+"?m=Wd&s=getWdInsideHuodonglist&is_open=1&name="+numeber+"&start="+star+"&limit="+size+"&ptid="+relational.ptid;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajxaGet(jikID) {
    $.ajax(
        {
            type: "GET",
            url: relational.url+"?m=Wd&s=getWdInsideHuodongInfo&hdid="+jikID,
            success: ajxaGetScs,
        }
    )
}
...
function ajaxAdd(data) {
    ...
    $.ajax(
        {
            type: "POST",
            url: relational.url+"?m=Wd&s=addWdInsideHuodong",
            data:data,
            success: ajaxAddScs,
        }
    )
