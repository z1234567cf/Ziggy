...
function dataClassify(data) {
    ...
    _1=[
        {"wjid":data["wjid"], "zcf_name":"wjid",},
        {"ptname":data["ptname"], "zcf_name":"ptname",},
    ];
    _2=[
        {"today_apr":data["today_apr"], "zcf_name":"today_apr",},
    ];
    _3=[
...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Wj&s=getWjPtList&is_open=0&start="+star+"&limit="+evSize;
            break;
        case 1:
            url=relational.url+"?m=Wj&s=getWjPtList&is_open=1&start="+star+"&limit="+evSize;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Wj&s=getWjPtList&is_open=0&name="+numeber+"&start="+star+"&limit="+size;
            break;
        case 1:
            url=relational.url+"?m=Wj&s=getWjPtList&is_open=1&name="+numeber+"&start="+star+"&limit="+size;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajxaGet(jikID) {
    $.ajax(
        {
            type: "GET",
            url: relational.url+"?m=Wj&s=getWjPtInfo&wjid="+jikID,
            success: ajxaGetScs,
        }
    )
}
...
function ajaxAdd(data) {
    $.ajax(
        {
            type: "POST",
            url: relational.url+"?m=Wj&s=addWjPt",
            data:data,
            success: ajaxAddScs,
        }
    )
