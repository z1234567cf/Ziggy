...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=AdManage&s=getDateEndList&is_open=0&start="+star+"&limit="+evSize;
            break;
        case 1:
            url=relational.url+"?m=AdManage&s=getDateEndList&is_open=1&start="+star+"&limit="+evSize;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=AdManage&s=getDateEndList&is_open=0&mobile="+numeber+"&start="+star+"&limit="+size;
            break;
        case 1:
            url=relational.url+"?m=AdManage&s=getDateEndList&is_open=1&mobile="+numeber+"&start="+star+"&limit="+size;
            break;
    }
    $.ajax({
        type: "GET",
