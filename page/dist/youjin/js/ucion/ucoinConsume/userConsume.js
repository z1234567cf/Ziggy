...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Account&s=userAccountFlowList&is_open=0&start="+star+"&limit="+ evSize +
                "&trid="+relational.trid+
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end;
            break;
        case 1:
            url=relational.url+"?m=Account&s=userAccountFlowList&is_open=1&start="+star+"&limit="+evSize +
                "&trid="+relational.trid+
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end;
            break;
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Account&s=userAccountFlowList&is_open=0&mobile="+numeber+"&start="+star+"&limit="+size+
                "&trid="+relational.trid+
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end;
            break;
        case 1:
            url=relational.url+"?m=Account&s=userAccountFlowList&is_open=1&mobile="+numeber+"&start="+star+"&limit="+size+
                "&trid="+relational.trid+
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end;
            break;
