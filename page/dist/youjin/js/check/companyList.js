...
function dataClassify(data) {
    ...
    _5=[
        {"www_url":data["www_url"], "zcf_name":"www_url",},
    ];
    _6=[
        {"www_name":data["www_name"], "zcf_name":"www_name",},
    ];
    _7=[
        {"com_image":data["com_image"], "zcf_name":"com_image",},
    ];
    _8=[
    ...
    var _data=[_1,_2,_3,_4,_5,_6,_7,_8,_9];
    return _data;
}
/*
 * ajax类
...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Manage&s=getCompanyAuthList&is_open=0&start="+star+"&limit="+evSize;
            break;
        case 1:
            url=relational.url+"?m=Manage&s=getCompanyAuthList&is_open=1&start="+star+"&limit="+evSize;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Manage&s=getCompanyAuthList&is_open=0&mobile="+numeber+"&start="+star+"&limit="+size;
            break;
        case 1:
            url=relational.url+"?m=Manage&s=getCompanyAuthList&is_open=1&mobile="+numeber+"&start="+star+"&limit="+size;
            break;
    }
    $.ajax({
        type: "GET",
