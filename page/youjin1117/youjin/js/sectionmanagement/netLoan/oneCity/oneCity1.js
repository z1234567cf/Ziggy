...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Wd&s=searchByName&is_open=0&start="+star+"&limit="+evSize+"&bus_model=1";
            break;
        case 1:
            url=relational.url+"?m=Wd&s=searchByName&is_open=1&start="+star+"&limit="+evSize+"&bus_model=1";
            break;
    }
    $.ajax({
        type: "GET",
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Wd&s=searchByName&is_open=0&name="+numeber+"&start="+star+"&limit="+size+"&bus_model=1";
            break;
        case 1:
            url=relational.url+"?m=Wd&s=searchByName&is_open=1&name="+numeber+"&start="+star+"&limit="+size+"&bus_model=1";
            break;
    }
    $.ajax({
        type: "GET",
