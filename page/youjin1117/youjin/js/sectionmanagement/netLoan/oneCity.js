...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Chedai&s=getStoreList&is_open=0&start="+star+"&limit="+evSize+"&ptid="+relational.ptid;
            break;
        case 1:
            url=relational.url+"?m=Chedai&s=getStoreList&is_open=1&start="+star+"&limit="+evSize+"&ptid="+relational.ptid;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Chedai&s=getStoreList&is_open=0&name="+numeber+"&start="+star+"&limit="+size+"&ptid="+relational.ptid;
            break;
        case 1:
            url=relational.url+"?m=Chedai&s=getStoreList&is_open=1&name="+numeber+"&start="+star+"&limit="+size+"&ptid="+relational.ptid;
            break;
    }
    $.ajax({
        type: "GET",
