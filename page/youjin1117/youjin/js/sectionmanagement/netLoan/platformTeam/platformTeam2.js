...
function dataClassify(data) {
    ...
    _1=[
        {"mgid":data["mgid"], "zcf_name":"mgid",},
        {"name":data["name"], "zcf_name":"name",},
    ];
    _2=[
        {"job":data["job"], "zcf_name":"job",},
    ];
    var _data=[_1,_2];
    return _data;
}
...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=Wd&s=getWdManagelist&is_open=0&start="+star+"&limit="+evSize+"&ptid="+relational.ptid;
            break;
        case 1:
            url=relational.url+"?m=Wd&s=getWdManagelist&is_open=1&start="+star+"&limit="+evSize+"&ptid="+relational.ptid;
            break;
    }
    $.ajax({
        type: "GET",
...
function ajxaGet(jikID) {
    $.ajax(
        {
            type: "GET",
            url: relational.url+"?m=Wd&s=getWdManageInfo&mgid="+jikID,
            success: ajxaGetScs,
        }
    )
}
...
function ajaxAdd(data) {
    ...
    $.ajax(
        {
            type: "POST",
            url: relational.url+"?m=Wd&s=addWdManage",
            data:data,
            success: ajaxAddScs,
        }
    )
