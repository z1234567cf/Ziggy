...
function dataClassify(data) {
    ...
    _5=[
        {"unknow":data["unknow"], "zcf_name":"unknow",},
    ];
...
function ajaxN(star,evSize) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=UserManage&s=getUserLinkList&is_open=0&start="+star+"&limit="+ evSize +
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end+
                "&s_type="+relational.s_type;
            break;
        case 1:
            url=relational.url+"?m=UserManage&s=getUserLinkList&is_open=1&start="+star+"&limit="+evSize +
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end+
                "&s_type="+relational.s_type;
            break;
...
function ajaxSearch(star,size,numeber) {
    ...
    switch (relational.if_open){
        case 0:
            url= relational.url+"?m=UserManage&s=getUserLinkList&is_open=0&mobile="+numeber+"&start="+star+"&limit="+size+
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end+
                "&s_type="+relational.s_type;
            break;
        case 1:
            url=relational.url+"?m=UserManage&s=getUserLinkList&is_open=1&mobile="+numeber+"&start="+star+"&limit="+size+
                "&time_start="+relational.time_start+
                "&time_end="+relational.time_end+
                "&s_type="+relational.s_type;
            break;
